...
**Brand:** Samuel Freeman · Chief Persuasion Architect · **Freeman Intelligence** (`BRAND-IDENTITY.md`).  
**12-month plan:** `strategy/FREEMAN-INTELLIGENCE-12-MONTH-PLAN.md` · `factory/business-plan.json`.  
...
- **Samuel Freeman / Freeman Intelligence** — Chief Persuasion Architect; AI persuasion systems for growth operators (`BRAND-IDENTITY.md`)
...
### Long-form (direct response + Hopkins + Kennedy + Caples + Sugarman)
...
- **Strategy of Preeminence** — fiduciary advisor posture; moral obligation to advocate if the offer truly helps (Abraham)
- **Three levers:** N (clients) × V (transaction value) × F (frequency) — +10% each ≈ +33% revenue; classify every asset by which lever it moves
- **Power Parthenon** — 8–12 acquisition/monetization pillars; flag single-channel dependency
...
### Copy momentum & triggers (Sugarman)
- **Slippery slide** — no decorative element; every headline, caption, bullet, and sentence has one job
- **First sentence law** — short, easy, curiosity-driven; sole purpose = read sentence two
- **31 psychological triggers** — activate 5–8 ethically per asset (involvement, honesty, curiosity, value, guarantee, storytelling, specificity, hope…)
- **Involvement devices** — quizzes, imagine prompts, calculators, self-assessment
- **Flaw → feature** — admit weakness honestly, then reframe (BluBlocker method)
...
### 4 — Edit
Run `EDITOR-PASSES.md` every time. **Sugarman slide pass:** first sentence shorter, seeds of curiosity added, dead weight cut. Never ship first drafts.
...
- `BRAND-IDENTITY.md` — Samuel Freeman, Freeman Intelligence, positioning
...
- `strategy/FREEMAN-INTELLIGENCE-12-MONTH-PLAN.md` — 10-book roadmap Sep 2026–Aug 2027
...
- `strategy/FREEMAN-INTELLIGENCE-POWERS-OPERATING-MODEL.md` — applied Powers scorecard for PM
