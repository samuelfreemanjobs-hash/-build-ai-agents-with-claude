...
| Powers tests logged | ≥12 (1/month min) |
...
**Partners:** 3 warm outreach (invite only — no launch yet)
...
| Week | Content | Email | Other |
|---|---|---|---|
| W1 | WHY: random AI ≠ system | Playbook map tease | BFCM prep |
| W2 | WHAT: 1-page playbook lead magnet | BFCM early access | |
| W3 | HOW: workflow pick-one exercise | Bundle email 1–3 | |
| W4 | WHAT IF: **BFCM 3-book stack** | Cart close sequence | Black Friday |
...
| Week | Content | Email | Other |
|---|---|---|---|
| W1 | WHY: funnel leaks | Year-end story | Consulting slots open |
| W2 | WHAT: N×V×F dashboard teach | Intensive invite | |
| W3 | HOW: leak audit worksheet | Intensive reminder | |
| W4 | WHAT IF: strategy intensive $1.5K | Last call | |
...
## M5 — Jan 2027 · OPEN · No new book

**Lever:** F (frequency · back-catalog)

### Marketing (opportunistic — pre-planned)
...
| Ops | Target |
|---|---|
| Factory | **No new manuscript** — catch-up edits only |
| Ship | Challenge workbook PDF |
| Backend | Challenge → cohort upsell |
| Metrics | Challenge show-up · conversion |
...
| Ops | Target |
|---|---|
| Factory | Box set metadata · cover briefs |
| Ship | Workshop deliverables |
| Backend | Agency Sprint fulfillment |
| Metrics | Workshop revenue · NPS |
...
| Week | Content | Email | Other |
|---|---|---|---|
| W1 | WHY: no flywheel | Box set tease | Year 2 RSE waitlist |
| W2 | WHAT: full stack reveal | Box early bird | |
| W3 | HOW: capstone install | **Complete PM Box $39.99** | |
| W4 | WHAT IF: price raise announce | Year 2 plan preview | Annual planning webinar |
...
## Weekly rhythm (every month)

| Day | Marketing (planned) | Operations (planned) |
|---|---|---|
| **Mon** | Week content confirm | Factory week target set |
| **Tue–Thu** | Execute calendar | Daily chapter + emails |
| **Fri** | Engagement review | GOO + Powers test log |
| **Month-end** | Actual vs plan | Next month template filled |
...
**Refresh:** 1st of month — roll forward · lock metrics · publish next month detail plan.
