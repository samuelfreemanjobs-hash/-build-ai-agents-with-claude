...
## Idealized design (Day 90 reader state)

> Growth operator runs a **documented persuasion + agent system** — one Kindle deep, on the email list, implemented at least one 10-minute install from free content, and knows whether their next step is book, cohort, or architecture call.
...
## VOC → 10 emotional pillars (Year 1 content spine)

*Mapped to Kindle pipeline + RSE themes — order by emotional impact.*
...
## Product IS the marketing (factory sync)
...
**Weekly factory rhythm:**

| Day | AM | PM |
|---|---|---|
| Mon–Fri | `factory chapter` | Extract 1 Guru Blueprint module → 3 platform natives |
| Sat | Batch 1→10 from week's master | |
| Sun | Plan next week pillar (WHY/WHAT/HOW/WHAT IF) | |

---

## Q1 90-day calendar (Sep–Nov 2026) — Guru Blueprint rhythm

### Month 1 (Sep) — Pillar 1–2: AI slop + psychology
...
### Month 2 (Oct) — Pillar 3–4: Agents + systems
...
| Week | Style | Asset | Platform | CTA |
|---|---|---|---|---|
| 1 WHY | "Random AI ≠ revenue system" | Video short | | |
| 2 WHAT | AI DR Playbook 1-page map | Lead magnet | Free line | |
| 3 HOW | Pick one workflow node to automate | Workshop clip | | |
| 4 WHAT IF | BFCM bundle + urgency | Email series | 10% promo cap | 3-book stack |
...
| Type | % | Examples |
|---|---|---|
| **Teach (EBM)** | 70% | Framework carousels, HOW installs, factory excerpts |
| **Proof / story** | 20% | Client results, war stories, industrial angle |
| **Direct promo** | 10% | Kindle, cohort, call — earned after teach week |

---

## Three-brain + four styles (default post structure)

Every LinkedIn / email follows:

```
REPTILIAN: One-line pattern interrupt
LIMBIC: 3-sentence peer story
NEOCORTEX: Named framework (3 bullets max)
HOW: Numbered steps (specific)
WHAT IF: "Do this in the next 10 minutes…"
CTA: One trackable action
```

---

## Live events (Guru Blueprint flywheel)
...
- [ ] Content traces to factory `active_book` in `factory/state.json`
- [ ] Each month has one **free line move** shipped
- [ ] 70/20/10 ratio tracked
- [ ] Burchard partners receive EBM samples (not raw promo)
- [ ] Kern 10MDMS fortress emails use chapter excerpts as belief content

---

**Refresh:** 1st of each month — extend 90-day horizon; align pillars to active `product_id` in business plan.
